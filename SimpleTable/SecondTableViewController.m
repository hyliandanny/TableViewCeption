...
@synthesize prepTime;
@synthesize manualViewControllerParent;
...
{
    manualViewControllerParent = inManualViewControllerParent;
}
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    if (!prepTime)
    {
        prepTime = [NSArray arrayWithObjects:@"10 min", @"10 min", @"20 min", @"20 min", @"30 min", @"10 min", @"10 min", @"10 min", @"10 min", @"10 min", @"35 min", @"15 min", @"40 min", @"10 min", @"10 min", @"17 min", nil];
    }
...
{
    static NSString *simpleTableIdentifier = @"SecondTableItem";
